...
test11 :: IO()
test11 = putStrLn $ show $ map evalDynCFAE tests

test12 :: IO()
test12 = putStrLn $ show $ map evalStatCFAE tests
...
test13 :: IO()
test13 = putStrLn $ show $ map evalCFBAE tests

test14 :: IO()
test14 = putStrLn $ show $ map evalDynCFAE tests

test15 :: IO()
test15 = putStrLn $ show $ map evalStatCFAE tests
